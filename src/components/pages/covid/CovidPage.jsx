...
import { fetchArticle } from '../../../features/covid/covidSlice'
...
function CovidPage() {
  ...
  const allArticles = useSelector((state) => state.covid.article)
  const loading = useSelector((state) => state.covid.isLoading)
